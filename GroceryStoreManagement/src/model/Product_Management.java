...
public class Product_Management {
    ...
    public String toString() {
        return "Product_Management{" + "ordinal_numbers=" + ordinal_numbers + ", id_product=" + id_product + ", name_product=" + name_product + ", unit_size=" + unit_size + ", quantity=" + quantity + ", reveneu=" + reveneu + ", date_pro=" + date_pro + '}';
    }
