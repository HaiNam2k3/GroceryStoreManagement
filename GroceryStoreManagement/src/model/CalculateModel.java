...
public class CalculateModel {
    ...
    public CalculateModel(int ordinal_numbers, String id_product, String name_product, int quantity, int unit_price, int total) {
    ...
    public CalculateModel(String id_product, String name_product, int quantity, int unit_price, int total) {
        this.id_product = id_product;
        this.name_product = name_product;
        this.quantity = quantity;
        this.unit_price = unit_price;
